from components.ai import NeutralEnemy, HostileEnemy, HostileFlyingEnemy
...
serpent = Actor(x=0,
                y=0,
                facing=0,
                elevations=move_elevations['deep_water'],
                icon='serpent_image',
                name='Serpent',
...
chest = Entity(x=0,
               y=0,
               elevations=move_elevations['ocean'],
               icon='chest',
               name='Chest')
